        ...
        <div class="panel-body"><?php ViewMessage(); ?>
          <div class="table-responsive">
            <table class="table table-striped" id="tblmember">
              ...
              <tbody>
              <?php
                $db->go("SELECT tbl_pesan.*, tbl_member.nama, tbl_admin.username FROM tbl_admin, tbl_pesan JOIN tbl_member ON tbl_pesan.id_sender = tbl_member.id_member WHERE tbl_pesan.id_receiver = '$ids' AND tbl_admin.username = '$username' ORDER BY tbl_pesan.time_pesan DESC");
              ...
              <tr>
                ...
                <td><strong><?php if($kat=='B'){echo "<span class='label label-warning'>Re:</span> ".$subject;}else{echo $subject;} ?></strong></td>
                <td><?php echo $inf; ?></td>

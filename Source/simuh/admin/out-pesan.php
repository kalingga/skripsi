...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-envelope"></i> Pesan Keluar</h2>
        ...
        <div class="panel-body"><?php ViewMessage(); ?>
          <div class="table-responsive">
            <table class="table table-striped" id="tblmember">
              ...
              <tbody>
              <?php
                $db->go("SELECT tbl_pesan.*, tbl_member.nama, tbl_admin.username FROM tbl_admin, tbl_pesan JOIN tbl_member ON tbl_pesan.id_receiver = tbl_member.id_member WHERE tbl_pesan.id_sender = '$ids' AND tbl_admin.username = '$username' ORDER BY tbl_pesan.time_pesan DESC");

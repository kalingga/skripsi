      ...
      <div class="panel panel-default"><?php if(ViewMessage()){echo ViewMessage();end;} ?>
          ...
          <form class="form-horizontal form-bordered" method="POST" action="../action/krm-pesan.php"> 
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <option value=""></option>
                <?php 
                  $db->go("SELECT id_member, username FROM `tbl_member` ORDER BY username ASC");
                  $count = $db->numRows();
                  $no=1;
       ...
       <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          <button class="btn btn-info" name="kirim"><i class="fa fa-location-arrow"></i> Kirim</button></form>&nbsp;
